...
InfoAfterFile=
OutputDir=installer
OutputBaseFilename=AutomationStudioSelector_Setup_v1.3.0
...
begin
  ...
  WizardForm.WelcomeLabel2.Caption := 
    'This will install Automation Studio Selector v1.3.0 on your computer.' + #13#13 +
    ...
    'New in v1.3.0: Smart project path auto-detection for scripts, making deployment easier.' + #13#13 +
